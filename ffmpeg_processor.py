...
class FFmpegAudioProcessor:
    ...
    def _build_filter_chain(self) -> str:
        ...
        if self.filters["noise_gate"]["enabled"]:
            ...
            filters.append(f"silenceremove=start_periods=0:start_duration=0.1:start_threshold={threshold}dB:detection=peak")
    ...
    def process_audio_advanced(self, input_path: str, output_path: Optional[str] = None,
                              use_arnndn: bool = False) -> str:
        """
